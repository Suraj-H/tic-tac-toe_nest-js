...
export class test11649588777111 implements MigrationInterface {
    name = 'test11649588777111'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "endedAt" TIMESTAMP NOT NULL DEFAULT now(), "gameStatus" "public"."game_gamestatus_enum" NOT NULL DEFAULT 'WAITS_FOR_USER', "gameType" "public"."game_gametype_enum", "userOnePieceCode" "public"."game_useronepiececode_enum" NOT NULL DEFAULT 'O', "userOneId" integer, "userTwoId" integer, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
